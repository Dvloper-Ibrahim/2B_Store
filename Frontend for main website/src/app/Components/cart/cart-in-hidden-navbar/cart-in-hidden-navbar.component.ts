...
@Component({
  selector: 'app-cart-in-hidden-navbar',
  templateUrl: './cart-in-hidden-navbar.component.html',
  styleUrls: ['./cart-in-hidden-navbar.component.css']
})
export class CartInHiddenNavbarComponent implements OnInit{
