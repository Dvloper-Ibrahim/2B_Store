...
export class SubSubCategoryService {
  ...
  getSubSubCategoryByID(subSubCatId : number):Observable<ISubCategory>{
    return this.httpClient.get<ISubCategory>(`${environment.BaseApiUrl}/api/SubCategory/${subSubCatId}`);
  }

  // getSubSubCategoriesInCategory(catId : number):Observable<ISubCategory[]>{
  //   return this.httpClient.get<ISubCategory[]>(`${environment.BaseApiUrl}/api/SubCategory/parent_in_category/${catId}`);
  // }
  
  getSubSubCategories(subCatId:number):Observable<ISubCategory[]>{
